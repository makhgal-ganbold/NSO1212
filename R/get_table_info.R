#' @title Detailed Information about a Table and Its Classification
#'
#' @description Detailed information about a table and its classification on the API \href{http://opendata.1212.mn/en/doc}{opendata.1212.mn} which is supported by \href{http://www.en.nso.mn}{National Statistical Office of Mongolia (NSO)}
#'
...
#'
#' @return A list which contains table information and classification if the function is executed without error, but an object of class "try-error" containing the error message, if it fails. The list has following structure:
#' \describe{
...
get_table_info <- function (tbl_id, simplify = FALSE, try = FALSE) {
